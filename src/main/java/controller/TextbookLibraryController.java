...
@ViewController(value = "../../resources/layout/layout_textbook_lib.fxml")
public class TextbookLibraryController {
    ...
    private ArrayList<TextBook> dataList;

    @PostConstruct
    public void init() throws SQLException {
        TextbookImpl textbookDB = new TextbookImpl();
        dataList = (ArrayList<TextBook>) textbookDB.queryAllTextbook();
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            Label bsource = new Label();
            Label bnum = new Label();
            bname.setText(dataList.get(i).getBookName());
            bsource.setText(dataList.get(i).getBookSource());
            bnum.setText(dataList.get(i).getBookNum() + "本");
            VBox header = new VBox(bname, bsource, bnum);
            header.setMargin(bname, new Insets(10, 0, 0, 20));
            header.setMargin(bsource, new Insets(10, 0, 0, 20));
            header.setMargin(bnum, new Insets(10, 0, 0, 20));
